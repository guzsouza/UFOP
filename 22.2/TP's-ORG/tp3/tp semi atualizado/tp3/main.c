...
int main(int argc, char**argv) {
    ...
    */
    ...
    if (strcmp(argv[1], "random") == 0) {
        ...
        machine.NumInstructions = 10;
    } else if (strcmp(argv[1], "file") == 0) {
        instructions = readInstructions(argv[3], memoriesSize, &machine.NumInstructions);
    } 
    else {
        printf("Invalid option.\n");
        return 0;
